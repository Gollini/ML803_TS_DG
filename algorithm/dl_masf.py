...
class DepressionDetectionClassifier_DL_masf(DepressionDetectionClassifier_DL_erm):
    ...
    def fit(self, X, y):
        ...
        inner_model_optimizer = network.prep_model_optimizer(self.optimizer_params)
        ...
        outer_model_optimizer = network.prep_model_optimizer(self.optimizer_params)
        ...
        metric_network_model_optimizer = network.prep_model_optimizer(self.optimizer_params)    
...
class DepressionDetectionAlgorithm_DL_masf(DepressionDetectionAlgorithm_DL_erm):
    ...
    def __init__(self, config_dict = None, config_name = "dl_masf", train_optimizer = "sgd", learning_rate = 0.01):
        super().__init__(config_dict, config_name, train_optimizer, learning_rate)
