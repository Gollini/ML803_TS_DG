...
def prep_model_optimizer(optimizer_params: Dict[str, float]):
    """Define a tensorflow optimizer"""
    print(optimizer_params)
    if optimizer_params["optimizer"] == "sgd":
        model_optimizer = tf.optimizers.SGD(optimizer_params["learning_rate"])
    elif optimizer_params["optimizer"] == "rmsprop":
        model_optimizer = tf.optimizers.RMSprop(optimizer_params["learning_rate"])
    elif optimizer_params["optimizer"] == "adam":
        model_optimizer = tf.optimizers.Adam(optimizer_params["learning_rate"])
    elif optimizer_params["optimizer"] == "adadelta":
        model_optimizer = tf.keras.optimizers.Adadelta(optimizer_params["learning_rate"])
    elif optimizer_params["optimizer"] == "adamax":
        model_optimizer = tf.keras.optimizers.Adamax(optimizer_params["learning_rate"])
    elif optimizer_params["optimizer"] == "nadam":
        model_optimizer = tf.keras.optimizers.Nadam(optimizer_params["learning_rate"])
    # elif optimizer_params["optimizer"] == "storm":
    #     model_optimizer = StormOptimizer(lr=optimizer_params["learning_rate"])
